          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-8">
              ...
              <section className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 border border-gray-200 dark:border-gray-600">
                  ...
                  {mockTags.slice(0, 6).map((tag) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-gray-700 dark:text-gray-300 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 font-medium transition-colors">
                          {tag.name}
                        </span>
                ...
                <Link
                  to="/tags"
                  className="inline-flex items-center space-x-1 text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 font-medium mt-4 transition-colors"
                >
