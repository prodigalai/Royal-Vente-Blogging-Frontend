// src/components/Newsletter/Automations/AutomationsTab.tsx
...
const AutomationsTab: React.FC = () => {
  ...
  const handleToggleAutomation = (id: string, status: "active" | "paused") => {
  ...
  const automationTemplates = [
    {
      ...
      name: "Welcome Series",
      description:
        "Automatically welcome new subscribers with a series of onboarding emails.",
      icon: Mail,
    ...
    },
    {
      ...
      name: "Date-based",
      description:
        "Send personalized emails based on birthdays, anniversaries, or custom dates.",
      icon: Calendar,
    ...
    },
    {
      ...
      name: "Abandoned Cart",
      description:
        "Recover lost sales with automated abandoned cart email sequences.",
      icon: Target,
    ...
    },
    {
      ...
      name: "Drip Campaign",
      description:
        "Nurture leads with a series of educational and promotional emails.",
      icon: Zap,
      color: "bg-teal-50 border-teal-200",
      iconColor: "text-teal-600",
      buttonColor: "bg-teal-600 hover:bg-teal-700",
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="No Purchase 90 days">
                    No Purchase 90 days
                  </option>
                </select>
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      emails: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white text-gray-900"
                />
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Set up automated email sequences to engage your subscribers
          </p>
        </div>
        <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-teal-600">+2 this month</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-teal-600">+15% this month</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {(
                  automations.reduce((sum, a) => sum + a.openRate, 0) /
                  automations.length
                ).toFixed(1)}
                %
              </p>
              <p className="text-sm text-teal-600">+3.2% vs campaigns</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-teal-600">+18% this month</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {automationTemplates.map((template) => {
            ...
            return (
              <div
                key={template.id}
                className={`${template.color} border rounded-xl p-6 hover:shadow-md transition-all duration-200`}
              >
                <div className="flex items-center space-x-3 mb-4">
                  <div className="p-2 bg-white rounded-lg shadow-sm">
                    <Icon className={`${template.iconColor} w-5 h-5`} />
                  </div>
                ...
                <button
                  className={`w-full ${template.buttonColor} text-white px-4 py-2 rounded-lg transition-colors text-sm font-medium`}
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      <span className="flex items-center space-x-1">
                        ...
                        <span>
                          {automation.subscribers.toLocaleString()} subscribers
                        </span>
                      </span>
                      <span className="flex items-center space-x-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-blue-900">
                        {(
                          automation.subscribers * automation.emails
                        ).toLocaleString()}
                      </p>
